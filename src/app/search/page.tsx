...
async function SearchResults({ query, likedTrackIds }: { query: string; likedTrackIds: string[] }) {
        ...
        <section>
          ...
          <div className="space-y-2">
            {results.tracks
              ...
              .map((track) => (
                <SearchTrackRow key={track.id} track={track} likedTrackIds={likedTrackIds} />
              ))}
          </div>
        </section>
      )}
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Suspense fallback={
        ...
        <SearchResults query={q} likedTrackIds={likedTrackIds} />
      </Suspense>
    </div>
  )
}
